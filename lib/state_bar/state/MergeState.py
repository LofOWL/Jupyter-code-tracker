...
class MergeState:
    ...
    class Line:
        ...
        def create(self):
            ...
            self.parent.parent.vs.create_text(index_text_x,index_text_y,font=("Purisa",10),anchor='c',text=self.data[1])
            ...
            for parent_block in self.data[0]:
                ...
                self.parent.parent.vs.create_line(first_x1,first_mid_y,parent_x2,parent_mid_y,fill="black",width=1)
